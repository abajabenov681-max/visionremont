...
Специализации MVP: **Сантехник · Ремонтник · Плиточник · Мебельщик**.
...
| `specializations`, `master_specializations` | специализации MVP (Сантехник, Ремонтник, Плиточник, Мебельщик) и связь мастер↔специализация |
